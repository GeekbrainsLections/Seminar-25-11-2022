...
Команда в формате *git push <ключи> <Kимя удаленного репозитория> <имя ветки>* позволяет отправить нашу версию репозитория на внешний репозиторий. ТРЕБУЕТ АВТОРИЗАЦИИ на внешнем репозитории.