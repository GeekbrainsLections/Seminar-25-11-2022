...
Для слияния веток используется команда *git merge*. Для слияния веток, необходимо находится в ветке в которую будет происходить слияние, затем ввести *git merge <название ветки>*. Существую различные варианты разрешения конфликтов, если автоматического слияния не произошло.
