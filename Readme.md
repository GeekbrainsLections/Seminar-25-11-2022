...
Чтобы создать коммит в папку-репозиторий, надо в терминале ввести команду *git commit -m "название коммита"
...
Для слияния веток используется команда *git merge название ветки*. Если конфликта нет, то ветки сольются автоматически и последний коммит будет иметь название названия ветки. Если между старой и новой ветками существует конфликт, то согласовывать ветки нужно будет в ручную.
